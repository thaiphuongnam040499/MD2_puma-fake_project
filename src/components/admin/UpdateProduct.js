...
import { act_patch_newArrivals } from '../../redux/actions';
import { useLocation, useNavigate } from 'react-router-dom';
export default function CreateProduct() {
    const productUpdate = useLocation().state
    useEffect(()=>{
        setImageUrls(productUpdate.image)
    ...
    const handleUpdate = () => {
        dispatch(act_patch_newArrivals({id:productUpdate.id, image: imageUrls, name, price }))
